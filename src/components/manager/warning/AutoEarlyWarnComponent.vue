            ...
            <div class="table">
                <div class="table-content">
                    <el-table :data="tableData" height="720" border highlight-current-row stripe style="width: 100%"
                        ...
                        <el-table-column prop="content" label="评论内容" width="690px" align="center" :resizable="false" />
                        ...
                        <el-table-column label="操作" width="160px" align="center" :resizable="false">
                            <template #default="{ row }">
                                <el-button type="primary" size="small" @click="collect(row.id)">收藏</el-button>
                                <el-button type="info" size="small" @click="edit(row)">纠错</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
                </div>
