                    ...
                    <el-table :data="tableData" height="720" border highlight-current-row stripe style="width: 100%"
                        ...
                        <el-table-column label="操作" width="160px" align="center" :resizable="false">
                            <template #default="{ row }">
                                ...
                                <el-button type="danger" size="small" @click="cancel(row.id)">取消</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
                </div>
...
function queryComment(pager, size) {
    ...
    api.postEarlyWarnCommentList(pager, size, form.keyword, form.area, form.url, form.sort, 1, form.dateType,
...
function cancel(commentId) {
    api.postCancelEarlyWarning(commentId).then(Response => {
